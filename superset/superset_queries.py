...
DATASETS = {name: QUERIES[name] for name in [
    "Forename Rankings",
    "Surname Rankings",
    "Forename Trends",
    "Surname Trends",
...
DATASET_CONFIG = {
    "Forename Rankings": {
        ...
        "metrics": [
            ...
            {"metric_name": "Avg % of Year", "expression": "AVG(pct_of_year_total)", "d3format": ",.2f"},
        ],
    },
    "Surname Rankings": {
    ...
    "Forename Trends": {
        ...
        "metrics": [
            {"metric_name": "Total Births", "expression": "SUM(count)", "d3format": ",d"},
            {"metric_name": "Unique Names", "expression": "COUNT(DISTINCT name)", "d3format": ",d"},
        ],
    },
    "Surname Trends": {
        "dimensions": ["name", "country", "country_code", "year"],
    ...
    "Name Diversity": {
        ...
        "metrics": [
            ...
            {"metric_name": "Unique Names per 1M", "expression": "MAX(unique_names_per_m)", "d3format": ",.1f"},
            {"metric_name": "Total Births", "expression": "SUM(total_births)", "d3format": ",d"},
            {"metric_name": "Top-10 Concentration %", "expression": "AVG(top10_concentration_pct)", "d3format": ",.1f"},
        ],
    },
    "Gender-Neutral Names": {
    ...
    "Cross-Country Names": {
        ...
        "metrics": [
            {"metric_name": "Avg % of Births", "expression": "MAX(avg_pct_of_births)", "d3format": ",.4f"},
        ],
    },
    "Country Signature Names": {
        ...
        "metrics": [
            ...
            {"metric_name": "Global Avg %", "expression": "MAX(global_avg_pct)", "d3format": ",.4f"},
            {"metric_name": "Distinctiveness", "expression": "MAX(distinctiveness_ratio)", "d3format": ",.1f"},
        ],
    },
    "Biggest Movers": {
        "dimensions": ["name", "country", "country_code", "gender", "year"],
        "temporal": "year",
        "metrics": [
            {"metric_name": "Max Rank Change", "expression": "MAX(abs_rank_change)", "d3format": ",d"},
            {"metric_name": "Avg Rank Change", "expression": "AVG(rank_change)", "d3format": ",.1f"},
            {"metric_name": "Total Births", "expression": "SUM(count)", "d3format": ",d"},
        ],
    },
    "Letter Distribution": {
    ...
    "Source Quality Scorecard": {
        ...
        "metrics": [
            {"metric_name": "Row Count", "expression": "MAX(row_count)", "d3format": ",d"},
            {"metric_name": "Successes", "expression": "SUM(ingest_success_count)", "d3format": ",d"},
            {"metric_name": "Failures", "expression": "SUM(ingest_fail_count)", "d3format": ",d"},
            {"metric_name": "Last Success Rows", "expression": "MAX(last_success_rows)", "d3format": ",d"},
        ],
    },
    "Rejected Rows": {
        "dimensions": ["source_table", "filename", "rejection_reason"],
        "metrics": [
            {"metric_name": "Rejected Count", "expression": "SUM(rejected_count)", "d3format": ",d"},
        ],
    },
    "Forename Trends Multi-Year": {
        "dimensions": ["name", "country", "country_code", "gender", "year"],
        ...
        "metrics": [
            {"metric_name": "Total Births", "expression": "SUM(count)", "d3format": ",d"},
            {"metric_name": "% of Births", "expression": "AVG(pct_of_year_total)", "d3format": ",.4f"},
        ],
    },
    "Top Name Share": {
